...
__DEFINE__(1666172836264, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1666172836265,"./event-store":1666172836266}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666172836265, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1666172836266, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1666172836265,"./utils":1666172836267}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1666172836267, function(require, module, exports) {
...
return __REQUIRE__(1666172836264);
})()

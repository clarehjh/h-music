...
__DEFINE__(1668836922043, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1668836922044,"./event-store":1668836922045}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668836922044, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1668836922045, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1668836922044,"./utils":1668836922046}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1668836922046, function(require, module, exports) {
...
return __REQUIRE__(1668836922043);
})()
